...
'''
Das obige Originalskript wurde so angepasst, dass schon mit der Initialisierung
einer DigestDB eine DB übergeben werden kann. Es folgt noch eine Überschreibung
mit einer Decorator-Methode.
'''
